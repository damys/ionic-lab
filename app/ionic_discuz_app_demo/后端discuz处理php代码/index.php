...
$actionarray = array('getPortalCate','getPortalList','getPortalArticle','getThreadCate','getThreadList','getThreadContent','login','login2','threadPost','threadReply');
...
//发表帖子
function threadPost(){	
	$title=isset($_GET['title'])?dhtmlspecialchars($_GET['title']):'';
	$username=isset($_GET['username'])?dhtmlspecialchars($_GET['username']):'';
